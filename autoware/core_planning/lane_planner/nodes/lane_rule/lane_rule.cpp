...
//获取了多条全局路径后，根据vector_map的元素生成不同颜色的waypoints
...
int main(int argc, char** argv)
{
  ...
  pnh.param<double>("acceleration", config_acceleration, 1);                                                                    //速度规划过程中，加速度的限制
  pnh.param<int>("number_of_smoothing_count", config_number_of_smoothing_count, 0);  //路径平滑滤波的参数
...
//若不考虑红绿灯的时候走的轨迹
  ...
  //订阅lane_navi获取的全局路径/lane_waypoints_array
