...
private:
  ...
  /**
   * @brief 接收到原路径点的回调函数callback function for source poses
  ...
  /**
   * @brief 接收到要删除的路径点的回调函数callback function for delete poses
   ...
   * @param [in] method 插值方法interpolation method (option: "linear" or "spline")
